...
def build_pants_target(file_info):
  ...
  sources = ", ".join([_wrap_quotes(source) for source in file_info['sources']])
...
parser.add_argument('target_dir', help='full path to process for pants BUILD', action='append')
